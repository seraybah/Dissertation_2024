...
urlpatterns = [
    ...
    path('api/cash_on_delivery_success/<oid>/', views.cash_on_delivery_success, name="cash_on_delivery_success"),
    path('api/cash_on_delivery_api/<oid>/', views.cash_on_delivery_api, name="cash_on_delivery_api"),
