...
def vendor_dashboard(request):
    ...
    order = CartOrder.objects.filter(Q(payment_status="paid", vendor=request.user.vendor) | Q(payment_status="cash_on_delivery_pending", vendor=request.user.vendor)).order_by("-id")[:20]
...
def vendor_orders(request):
    ...
    order = CartOrder.objects.filter(Q(payment_status="paid", vendor=request.user.vendor) | Q(payment_status="cash_on_delivery_pending", vendor=request.user.vendor)).order_by("-id")
