...
DEBUG = True
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://development-server-production-test.up.railway.app']
...
JAZZMIN_SETTINGS = {
    'site_header': "FPPOS",
    'site_brand': "Farm Produce Point of Sale.",
    'site_logo': "images/logo.png",
    'copyright':  "All Right Reserved 2023",
    # "order_with_respect_to": ["store", 'vendor', "addons" , 'core' ,'userauths'],
    "welcome_sign": "Welcome to Farm Produce, Login Now.",
    "topmenu_links": [
