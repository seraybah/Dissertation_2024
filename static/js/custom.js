...
$(document).on("click", "#question-btn", function(){
    ...
    $(".add-to-cart-btn").on("click", function(){
        ...
        let color = $(".product-color-" + index).val()
...
// Increase Update item from cart
$(document).on('click', '#increase', function () {
    var _pId = $(this).attr('data-cart-index');
    var _vm = $(this);
    
    var quantityNum = $(".quantity-num-" + _pId).val();
    quantityNum ++
    $(".quantity-num-" + _pId).val(quantityNum)
    ...
    if (parseInt(_pQty) > parseInt(product_stock_qty)) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $(".subtotal"+_pId).html("<i class='fas fa-spinner fa-spin text-secondary'></i>")
            ...
            success: function (res) {
                ...
                _vm.text("<i class='fas fa-sync-alt'></i>");
            }
        });
    }
    // End
...
// Decrease Update item from cart
$(document).on('click', '#decrease', function () {
    ...
    $(document).ready(function(){
        $(document).on("click", '.color-button', function(){
            ...
            let color_image = $(".color-image-"+color_id).val()

            // main-img-div

            $("#color-input").val(color_name)
            $(".color-input").text(color_name)
            $(".main-img-div").attr("src", color_image);
            $(".main-a-div").attr("href", color_image);
        ...
        $(document).on("click", ".size-select", function(){
            ...
            $(".size-select").removeClass("btn-success");
            $(".size-select").addClass("btn-secondary");
            $(".size-select-" + id).removeClass("btn-secondary");
            $(".size-select-" + id).addClass("btn-success");

            $("#size-input").val(value)
            $(".size-input").text(value)
            $(".product-price-"+product_id).val(price)
